...
namespace LP_17
{
    public partial class Relatorio_Jogadores : Form
    {
        public Relatorio_Jogadores()
        {
            InitializeComponent();
        }

        private void Relatorio_Jogadores_Load(object sender, EventArgs e)
        {
        ...
        private void Relatorio_Jogadores_HelpButtonClicked(object sender, CancelEventArgs e)
        {
